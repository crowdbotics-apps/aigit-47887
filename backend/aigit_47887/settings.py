"""
Django settings for aigit_47887 project.
...
WSGI_APPLICATION = 'aigit_47887.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aigit_47887 API",
    "DESCRIPTION": "API documentation for aigit_47887 App",
    "VERSION": "v1",
}
